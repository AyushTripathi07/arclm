...
export namespace Prisma {
  ...
  */
  ...
  export type NotebookOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "icon" | "date" | "sources" | "highlight" | "content" | "lastModified", ExtArgs["result"]["notebook"]>
  ...
  interface NotebookFieldRefs {
    ...
    readonly date: FieldRef<"Notebook", 'String'>
    readonly sources: FieldRef<"Notebook", 'Int'>
    readonly highlight: FieldRef<"Notebook", 'Boolean'>
    readonly content: FieldRef<"Notebook", 'String'>
    readonly lastModified: FieldRef<"Notebook", 'DateTime'>
  }
  ...
  export type NotebookWhereInput = {
    ...
    icon?: StringFilter<"Notebook"> | string
    date?: StringFilter<"Notebook"> | string
    sources?: IntFilter<"Notebook"> | number
    highlight?: BoolFilter<"Notebook"> | boolean
    content?: StringNullableFilter<"Notebook"> | string | null
    lastModified?: DateTimeNullableFilter<"Notebook"> | Date | string | null
  }
  ...
  export type NotebookScalarWhereWithAggregatesInput = {
    ...
    icon?: StringWithAggregatesFilter<"Notebook"> | string
    date?: StringWithAggregatesFilter<"Notebook"> | string
    sources?: IntWithAggregatesFilter<"Notebook"> | number
    highlight?: BoolWithAggregatesFilter<"Notebook"> | boolean
    content?: StringNullableWithAggregatesFilter<"Notebook"> | string | null
    lastModified?: DateTimeNullableWithAggregatesFilter<"Notebook"> | Date | string | null
  }
  ...
  export type NotebookUpdateInput = {
    ...
    sources?: IntFieldUpdateOperationsInput | number
